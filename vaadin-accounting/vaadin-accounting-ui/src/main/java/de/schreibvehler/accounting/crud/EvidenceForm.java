...
import de.schreibvehler.accounting.samples.backend.data.Availability;
 ...
 * CSS rules.
 */
public class EvidenceForm extends ProductFormDesign {

    private CrudLogic viewLogic;
    private BeanFieldGroup<Product> fieldGroup;

    public EvidenceForm(CrudLogic sampleCrudLogic) {
        super();
