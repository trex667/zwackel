...
public class Menu extends CssLayout {
    ...
    private static final long serialVersionUID = -538828618305348773L;
    ...
    public Menu(Navigator navigator) {
        ...
        logoutMenu.addItem("Logout", FontAwesome.SIGN_OUT, new Command() {
            ...
            private static final long serialVersionUID = -709635781226969459L;
        ...
        final Button showMenu = new Button("Menu", new ClickListener() {
            private static final long serialVersionUID = -1926417181636475674L;
    ...
    private void createViewButton(final String name, String caption,
        ...
        Button button = new Button(caption, new ClickListener() {
            ...
            private static final long serialVersionUID = -1538018532375270955L;
