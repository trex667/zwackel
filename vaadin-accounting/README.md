...
- vaadin-accounting-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadin-accounting-ui: main application module, development time
- vaadin-accounting-production: module that produces a production mode WAR for deployment
