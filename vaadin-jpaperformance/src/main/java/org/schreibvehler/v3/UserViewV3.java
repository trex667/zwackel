...
@CDIView("V3")
public class UserViewV3 extends VerticalLayout implements View {

    private static final long serialVersionUID = 7277988489611347314L;

    @EJB(beanName = "UserServiceV3")
    ...
    public void enter(ViewChangeEvent event) {
        ...
        addComponents(new RichText().withMarkDownResource("/V3.md"), timeInterval);
